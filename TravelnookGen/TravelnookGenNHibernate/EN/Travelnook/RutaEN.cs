...
{
        this.init (Nombre, ruta.Descripcion, ruta.Provincia, ruta.Sitio, ruta.Favorito, ruta.Reporte, ruta.Puntuacion, ruta.NumPuntuados, ruta.FechaCreacion, ruta.PuntuacionMedia, ruta.Comentarios, ruta.Usuario);
}
