...
{
    partial class SitioCAD
    {
        public System.Collections.Generic.IList<TravelnookGenNHibernate.EN.Travelnook.SitioEN> Filtro_Dinamico(string sql, string p_nombre, string p_provincia, int p_puntuacion)
        {
            ...
            catch (Exception ex)
            {
                ...
                if (ex is TravelnookGenNHibernate.Exceptions.ModelException)
                    throw ex;
                throw new TravelnookGenNHibernate.Exceptions.DataLayerException("Error in SitioCAD_FiltroDinamico.", ex);
            }
