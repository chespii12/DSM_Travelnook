...
using System.Text;
using NHibernate;
using TravelnookGenNHibernate.CAD;
using TravelnookGenNHibernate.CAD.Travelnook; // <- Poner el nombre del proyecto NHibernate + GenHibernate.CAD + NombreProyectoOOH4RIA
                                // Acordaros de añadir la referencia al proyecto GenHibernate. (Add References) 

namespace TravelnookCP
{
